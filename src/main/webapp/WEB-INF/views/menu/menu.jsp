			...
			<div class="sidebar-nav navbar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a href="${enseignant }"><i
							class="fa fa-bar-chart-o fa-fw"></i> Enseignants</a> 
					<!-- INDUSTRIEL -->
					<c:url value="/industriel/" var="industriel" />
					<li><a href="${industriel }"><i
							class="fa fa-table fa-fw"></i> Industriels</a></li>
					<!-- MEDIA -->
					<c:url value="/media/" var="media" />
					<li><a href="${media }"><i
							class="fa fa-edit fa-fw"></i> Medias</a></li>
					<!-- PARTICIPANT -->
					<c:url value="/participant/" var="participant" />
					<li><a href="${participant }"><i
							class="fa fa-wrench fa-fw"></i>Participants 
			</div>
			<!-- /.sidebar-collapse -->
		</div>
		<!-- /.navbar-static-side -->
